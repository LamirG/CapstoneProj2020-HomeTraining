...
public class UpperbodyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.UBackButton);
        button.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View v){
                Intent intent = new Intent(getApplicationContext(), TrainningActivity.class);
                startActivity(intent);
            }
        });

        button = (Button) findViewById(R.id.UPushUpButton);
        button.setOnClickListener(new View.OnClickListener(){
